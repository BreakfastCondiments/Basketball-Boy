...
public class BoundingColliderFactory : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SpriteRenderer renderer = bottomCollider.gameObject.AddComponent<SpriteRenderer>();
        ...
        bottomCollider.position = new Vector3(cameraPos.x, cameraPos.y - screenSize.y - (bottomCollider.localScale.y * 0.5f) *.3f, zPosition);
